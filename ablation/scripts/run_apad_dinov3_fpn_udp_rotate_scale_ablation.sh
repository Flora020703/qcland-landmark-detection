#!/usr/bin/env bash
# =============================================================================
# run_apad_dinov3_fpn_udp_rotate_scale_ablation.sh — Abdomen/APAD, DINOv3,
# FPN+UDP + rotation + scale jitter, 5-seed. DINOv3 counterpart of
# run_apad_fpn_udp_rotate_scale_ablation.sh (DINOv2), completing the
# DINOv2-vs-DINOv3 backbone comparison across all 5 UCL anatomies per
# supervisor request (2026-07-22).
#
...
#
# CANARY MODE:
#   CANARY_ONLY=1 bash ablation/scripts/run_apad_dinov3_fpn_udp_rotate_scale_ablation.sh
#   bash ablation/scripts/run_apad_dinov3_fpn_udp_rotate_scale_ablation.sh   # remaining 4 seeds
#
...
#   cd /root/eomt
#   nohup bash ablation/scripts/run_apad_dinov3_fpn_udp_rotate_scale_ablation.sh > apad_dinov3_fpn_udp_rotate_scale_ablation.log 2>&1 &
# =============================================================================

set -euo pipefail

BASE_CONFIG="configs/landmark/apad_dinov3_fpn_udp_rotate_scale.yaml"
...
RUN_GROUP="apad-dinov3-fpn-udp-rotate-scale"
RESULTS_TSV="apad_dinov3_fpn_udp_rotate_scale_results.tsv"
DONE_MARKER="checkpoints/.apad_dinov3_fpn_udp_rotate_scale_completed_seeds.txt"
BACKUP_ROOT="/root/autodl-tmp/saved_checkpoints/apad_dinov3_fpn_udp_rotate_scale"
...
echo ""
echo "============================================================"
echo "  APAD DINOv3 (FPN+UDP+rotate+scale) — 5-seed ablation summary"
echo "============================================================"
