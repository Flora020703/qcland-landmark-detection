#!/usr/bin/env bash
# =============================================================================
# run_fl_dinov3_fpn_udp_rotate_scale_ablation.sh — Femur/FL, DINOv3,
# FPN+UDP + rotation + scale jitter, 5-seed. DINOv3 counterpart of
# run_fl_fpn_udp_rotate_scale_ablation.sh (DINOv2), completing the
...
#
# CANARY MODE:
#   CANARY_ONLY=1 bash ablation/scripts/run_fl_dinov3_fpn_udp_rotate_scale_ablation.sh
#   bash ablation/scripts/run_fl_dinov3_fpn_udp_rotate_scale_ablation.sh   # remaining 4 seeds
#
# Usage (on AutoDL server):
#   cd /root/eomt
#   nohup bash ablation/scripts/run_fl_dinov3_fpn_udp_rotate_scale_ablation.sh > fl_dinov3_fpn_udp_rotate_scale_ablation.log 2>&1 &
# =============================================================================

set -euo pipefail

BASE_CONFIG="configs/landmark/fl_dinov3_fpn_udp_rotate_scale.yaml"
...
RUN_GROUP="fl-dinov3-fpn-udp-rotate-scale"
RESULTS_TSV="fl_dinov3_fpn_udp_rotate_scale_results.tsv"
DONE_MARKER="checkpoints/.fl_dinov3_fpn_udp_rotate_scale_completed_seeds.txt"
BACKUP_ROOT="/root/autodl-tmp/saved_checkpoints/fl_dinov3_fpn_udp_rotate_scale"
...
echo ""
echo "============================================================"
echo "  FL DINOv3 (FPN+UDP+rotate+scale) — 5-seed ablation summary"
echo "============================================================"
