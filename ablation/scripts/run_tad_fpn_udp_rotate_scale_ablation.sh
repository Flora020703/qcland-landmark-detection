#!/usr/bin/env bash
# =============================================================================
# run_tad_fpn_udp_rotate_scale_ablation.sh — Abdomen/TAD, DINOv2, FPN+UDP
# + rotation + scale jitter, 5-seed. See run_apad_fpn_udp_rotate_scale_ablation.sh
# for full rationale — identical setup, same images/split as APAD, only the
# target landmark columns differ.
#
...
#
# CANARY MODE:
#   CANARY_ONLY=1 bash ablation/scripts/run_tad_fpn_udp_rotate_scale_ablation.sh
#   bash ablation/scripts/run_tad_fpn_udp_rotate_scale_ablation.sh   # remaining 4 seeds
#
# Usage (on AutoDL server):
#   cd /root/eomt
#   nohup bash ablation/scripts/run_tad_fpn_udp_rotate_scale_ablation.sh > tad_fpn_udp_rotate_scale_ablation.log 2>&1 &
# =============================================================================

set -euo pipefail

BASE_CONFIG="configs/landmark/tad_dinov2_fpn_udp_rotate_scale.yaml"
...
RUN_GROUP="tad-dinov2-fpn-udp-rotate-scale"
RESULTS_TSV="tad_fpn_udp_rotate_scale_results.tsv"
DONE_MARKER="checkpoints/.tad_fpn_udp_rotate_scale_completed_seeds.txt"
BACKUP_ROOT="/root/autodl-tmp/saved_checkpoints/tad_fpn_udp_rotate_scale"
...
echo ""
echo "============================================================"
echo "  TAD DINOv2 (FPN+UDP+rotate+scale) — 5-seed ablation summary"
echo "============================================================"
