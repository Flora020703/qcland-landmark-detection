#!/usr/bin/env bash
# =============================================================================
# run_tad_dinov3_fpn_udp_rotate_scale_ablation.sh — Abdomen/TAD, DINOv3,
# FPN+UDP + rotation + scale jitter, 5-seed. DINOv3 counterpart of
# run_tad_fpn_udp_rotate_scale_ablation.sh (DINOv2), completing the
...
#
# CANARY MODE:
#   CANARY_ONLY=1 bash ablation/scripts/run_tad_dinov3_fpn_udp_rotate_scale_ablation.sh
#   bash ablation/scripts/run_tad_dinov3_fpn_udp_rotate_scale_ablation.sh   # remaining 4 seeds
#
# Usage (on AutoDL server):
#   cd /root/eomt
#   nohup bash ablation/scripts/run_tad_dinov3_fpn_udp_rotate_scale_ablation.sh > tad_dinov3_fpn_udp_rotate_scale_ablation.log 2>&1 &
# =============================================================================

set -euo pipefail

BASE_CONFIG="configs/landmark/tad_dinov3_fpn_udp_rotate_scale.yaml"
...
RUN_GROUP="tad-dinov3-fpn-udp-rotate-scale"
RESULTS_TSV="tad_dinov3_fpn_udp_rotate_scale_results.tsv"
DONE_MARKER="checkpoints/.tad_dinov3_fpn_udp_rotate_scale_completed_seeds.txt"
BACKUP_ROOT="/root/autodl-tmp/saved_checkpoints/tad_dinov3_fpn_udp_rotate_scale"
...
echo ""
echo "============================================================"
echo "  TAD DINOv3 (FPN+UDP+rotate+scale) — 5-seed ablation summary"
echo "============================================================"
